...
class StartMenu { // класс главного меню программы
    ...
    public StartMenu() throws SQLException { // конструктор
        showGameLevels();
        makeChoose();
        readChoose();
    }
    ...
    private void readChoose() throws SQLException { // метод для считывания сделанного выбора
        ...
        if (gameType.contentEquals("0")){
            ...
            // закрытие statement и connection не выполняется, т.к. если ни одна игра не была начата,
            // подключение к БД не выполнялось.
            // Если игра была сыграна, то отключение от БД выполнилось в классе варианта игры.
           // statement.close();
           // connection.close();
            System.exit(0);
        }
...
class LevelTwo extends Connector { // класс игры с двумя словами-ассоциациями
    ...
    public LevelTwo() throws SQLException {
        intro();
        play();
    }
...
class LevelThree extends Connector{
    ...
    public LevelThree() throws SQLException {
        intro();
        play();
    }
...
class LevelFour extends Connector{
    ...
    public LevelFour() throws SQLException {
        intro();
        play();
    }
...
class LevelFive extends Connector{
    ...
    public LevelFive() throws SQLException {
        intro();
        play();
    }
